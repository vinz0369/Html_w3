...
<body>
    ...
    <?php
    function tinhDiemTrungBinh($diemtoan, $diemly, $diemhoa, $diemanh, $diemvan, $diemsu) {
  

    $trungbinh = ($diemtoan + $diemly + $diemhoa + $diemanh + $diemvan + $diemsu) / 6;
...
<?php
    ...
    $trungbinh = tinhDiemTrungBinh($diemtoan, $diemly, $diemhoa, $diemanh, $diemvan, $diemsu);
